// Shared News-feed loader for the Cliffe Lab site.
// Reads .txt + image pairs from a "News" folder in the GitHub repo via the public
// GitHub Contents API (no build step, no server — works from a static GitHub Pages site).
//
// Expected file format in /News:
...
//
// .txt contents:
//   Title:"Long title of the news"
//   Message:"The message that will appear in the news article"
//   [End]
